<?php
session_start();
// $_SESSION["oppstate"] = $_POST["oppstate"];
// $_SESSION["oppcity"] = $_POST["oppcity"];
// $_SESSION["opppoliceStation"] = $_POST["opppoliceStation"];
// $_SESSION["opponent"] = $_POST["opponent"];
// $_SESSION["oppage"] = $_POST["oppage"];
// $_SESSION["oppfather"] = $_POST["oppfather"];
// $_SESSION["oppaddress"] = $_POST["oppaddress"];
// $_SESSION["oppmobile"] = $_POST["oppmobile"];
...
<body onload="getLocation()">
    <div class="main">
        ...
        <div class="formelement">
                 <form action="156 3.php" method="POST">
                    <input type="hidden" id="ipAddress" name="ipAddress" value="">
                 <!-- state select starts -->
                     <label for="state">Select State:</label><br>
                     <select id="state" name="nystate" onchange="updateCities()">
                         <option value="">किस राज्य में मुक़दमा लड़ना है:</option>
                ...
                <!-- state select ends -->
                       ...
                       <label for="city">किस नयायालय में मुक़दमा दाखिल करना है:</label><br>
                       <select id="city" name="nycity" onchange="updatePoliceStations()">
                        <option value="">मुक़दमा का जिला चुने:</option>
                      <!-- Cities will be dynamically populated based on the selected state -->
                       </select>

                       <br>

                       <label for="policeStation">किस थाना में मुक़दमा दाखिल करना है:</label><br>
                       <select id="policeStation" name="nypoliceStation">
                        <option value="">दाखिले का थाना चुने:</option>
                       <!-- Police stations will be dynamically populated based on the selected city -->
                       </select>

                       
                        <br>
                        <label for="policeStation">मजिस्ट्रेट का पद और कक्ष संख्या चुने :</label><br>
                        <select name="nycourtroom">
                        <option value="सी0जे0एम्0 ">सी0जे0एम्0 </option>
                        <option value="ए0सी0जे0एम्0 ">ए0सी0जे0एम्0 </option>
                        </select>
                        <br>
                        ...
                        <br>
                        <label for="policeStation">मजिस्ट्रेट का पद और कक्ष संख्या चुने :</label><br>
                        <select name="nycourtnumber">
                        <option value=" कक्ष सं0- 1">कक्ष सं0- 1</option>
                        <option value=" कक्ष सं0- 2">कक्ष सं0- 2</option>
                        <option value=" कक्ष सं0- 3">कक्ष सं0- 3</option>
                        <option value=" कक्ष सं0- 4">कक्ष सं0- 4</option>
                        <option value=" कक्ष सं0- 5">कक्ष सं0- 5</option>
                        <option value=" कक्ष सं0- 6">कक्ष सं0- 6</option>
                        <option value=" कक्ष सं0- 7">कक्ष सं0- 7</option>
                        <option value=" कक्ष सं0- 8">कक्ष सं0- 8</option>
                        </select>
                        <br>
                      

                    <!-- year select starts -->
                    <label for="datee">नयायालय में किस सन में वाद दाखिक कर रहे है :</label><br>
                     <select name="nydatee" id="yearSelect">
    <!-- JavaScript will populate the options here -->
                        </select>

                    <script>
                    // Use JavaScript to dynamically generate options for years from 1947 to 3000
                         var yearSelect = document.getElementById("yearSelect");
                    for (var year = 1947; year <= 3000; year++) {
