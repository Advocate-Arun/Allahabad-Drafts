...
<body onload="getLocation()">
    <div class="main">
        ...
        <div class="formelement">
                 <form action="opposite.php" method="POST">
                    <input type="hidden" id="ipAddress" name="ipAddress" value="">
                 <!-- state select starts -->
                     <label for="state">Select State:</label><br>
                     <select id="state" name="appstate" onchange="updateCities()">
                         <option value="">आप किस राज्य में रहते है:</option>
                ...
                <!-- state select ends -->
                       ...
                       <label for="city">आप किस जिले के निवासी है:</label><br>
                       <select id="city" name="appcity" onchange="updatePoliceStations()">
                      ...
                      <!-- Cities will be dynamically populated based on the selected state -->
                       ...
                       <label for="policeStation">अपना घर किस थाना क्षेत्र में पड़ता है:</label><br>
                       <select id="policeStation" name="apppoliceStation">
                        <option value="">अपना थाना चुने:</option>
                    ...
                    <label for="mobile">प्रार्थी/वादी का नाम :</label><br>
                    <input type="text" id="" name="applicant" title="प्रार्थी का नाम " required>
                     <br>
                     <label for="mobile">प्रार्थी की आयु लगभग कितने वर्ष की है ?</label><br>
                     <select name="appage" id="ageSelect">
                     ...
                     <br>
                    <label for="mobile">प्रार्थी/वादी के पिता का नाम  :</label><br>
                     <input type="text" id="" name="appfather" title="प्रार्थी के पिता का नाम " required>
                     <br>
                     <label for="mobile">प्रार्थी का पता :</label><br>
                     <input type="text" id="" name="appaddress" title="प्रार्थी के पिता का नाम " required>
                    <br>
                     <label for="mobile">मोबाइल नंबर:</label><br>
                    <input type="text" id="mobile" name="appmobile" pattern="[0-9]{10}" title="Enter a 10-digit mobile number" required>
                    <br>
                   

                <input type="submit" name="submit_applicant" value="Submit" style="width: 80px;
                height: 40px;
                border-radius: 30px;
